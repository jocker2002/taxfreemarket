...
(function($) {
    ...
    function xobject(mObj, opts) {
        ...
        function prepare_zoom(x, y) {
            ...
            if (xzoomID.length == 0 && current.options.position != 'inside' && current.options.position != 'fullscreen') {
                ...
                if (!current.options.adaptive || !osw || !osh) { osw = sw;
                    osh = sh; }
        ...
        this.openzoom = function(event) {
            ...
            imgObj.xon('load', function(e) {
                ...
                if (current.options.smooth) { flag = true;
        ...
        this.xappend = function(Obj) {
            ...
            if (index == 0 && current.options.activeClass) { active = Obj;
    ...
    $.fn.xzoom = function(options) {
            ...
            this.each(function(index) {
                if (el.length == 1) {
                    if (index == 0) {
                        ...
                        contentObj = $(this);
                        if (typeof(contentObj.data('xzoom')) !== 'undefined') return contentObj.data('xzoom');
                        contentObj.x = new xobject(contentObj, options);
                    } else if (typeof(contentObj.x) !== 'undefined') {
                        //Thumbs
                        secObj = $(this);
                        contentObj.x.xappend(secObj);
                    }
                } else {
                    if ($(this).is(el[0]) && index == 0) {
                        ...
                        if (typeof(contentObj.data('xzoom')) !== 'undefined') return contentObj.data('xzoom');
                        contentObj.x = new xobject(contentObj, options);
                    } else if (typeof(contentObj.x) !== 'undefined' && !$(this).is(el[0])) {
                        //Thumbs
                        secObj = $(this);
                        contentObj.x.xappend(secObj);
                    }
        ...
        if (typeof(contentObj) === 'undefined') return false;
        contentObj.data('xzoom', contentObj.x);

        //Fire event xzoom init
        $(contentObj).trigger('xzoom_ready');
        return contentObj.x;
    }
